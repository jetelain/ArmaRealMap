...
namespace ArmaRealMap.Test
{
    public class PlacedTerrainObjectTest
    {
        ...
        {
            var objInitial = new PlacedTerrainObject(new ModelInfo() { Path = "test.p3d", Name = "test" }, new TerrainPoint(256, 512), 128, ElevationMode.Absolute);
            ...
            // TODO: Assert Matrix
            var objBack = new PlacedTerrainObject(wrp, new ModelInfoLibrary());
            Assert.Equal(@"""test"";200256.000;512.000;0.000;0.000;0.000;1.000;128.000;", objBack.ToTerrainBuilderCSV());
            
            //

            objInitial = new PlacedTerrainObject(new ModelInfo() { Path = "test.p3d", Name = "test" }, new TerrainPoint(256, 512), 128, ElevationMode.Absolute, 45);
            ...
            // TODO: Assert Matrix
            objBack = new PlacedTerrainObject(wrp, new ModelInfoLibrary());
            Assert.Equal(@"""test"";200256.000;512.000;45.000;0.000;0.000;1.000;128.000;", objBack.ToTerrainBuilderCSV());

            //

            objInitial = new PlacedTerrainObject(new ModelInfo() { Path = "test.p3d", Name = "test" }, new TerrainPoint(256, 512), 128, ElevationMode.Absolute, 0, 45, 0);
            ...
            objInitial = new PlacedTerrainObject(new ModelInfo() { Path = "test.p3d", Name = "test" }, new TerrainPoint(256, 512), 128, ElevationMode.Absolute, 90, 65, 35);
            ...
            objInitial = new PlacedTerrainObject(new ModelInfo() { Path = "test.p3d", Name = "test" }, new TerrainPoint(17929, 43049.27f), 292.99362f, ElevationMode.Absolute, -160.467f, 4.071f, 0f);
