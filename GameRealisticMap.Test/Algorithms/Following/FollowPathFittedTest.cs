...
namespace GameRealisticMap.Test.Algorithms.Following
{
    public class FollowPathFittedTest
    {
        ...
        [Fact]
        public void PlaceOnPathRightAngleV2_Corner_Square()
        {
            var definition = new TestSegmentsDefinition(
                new TestCornerOrEndSegmentDefinition("Left"),
                new TestCornerOrEndSegmentDefinition("Right"),
            ...
            var list = new List<PlacedModel<string>>();
            FollowPathWithObjects.PlaceOnPathRightAngleV2(new Random(16), definition, list, TerrainPath.FromRectangle(new TerrainPoint(8, 8), new TerrainPoint(18, 18)).Points);
        ...
        [Fact]
        public void PlaceOnPathRightAngleV2_Ends()
        {
            var definition = new TestSegmentsDefinition(
                null,
                null,
        ...
        [Fact]
        public void PlaceOnPathRightAngleV2_Random_UseLongest()
        {
            var definition = new TestSegmentsDefinition(
        ...
        [Fact]
        public void PlaceOnPathRightAngleV2_Random_UseLongest_Straight()
        {
            var definition = new TestSegmentsDefinition(
                new TestStraightSegmentDefinition("Size4A", 4),
                new TestStraightSegmentDefinition("Size4B", 4),
        ...
        [Fact]
        public void PlaceOnPathRightAngleV2_Random_UseAnySize()
        {
            var definition = new TestSegmentsDefinition(
                new TestStraightSegmentDefinition("Size4A", 4),
                new TestStraightSegmentDefinition("Size4B", 4),
        ...
        [Fact]
        public void PlaceOnPathRightAngleV2_Random_UseAnySize_Straight()
        {
            var definition = new TestSegmentsDefinition(
                new TestStraightSegmentDefinition("Size4A", 4),
                new TestStraightSegmentDefinition("Size4B", 4),
