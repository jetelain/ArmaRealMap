...
![Workflow](./legacy/workflow-tb.svg)

## Workflow without Terrain Builder

Importing data in Terrain Builder can be really long, the new "PreCooked" workflow directly generates [layers and WRP files](./legacy/files.md).

![Workflow](./legacy/workflow-precooked.svg)

[Files for terrain builder](./legacy/files.md) are still generated and can be used as a fallback.
