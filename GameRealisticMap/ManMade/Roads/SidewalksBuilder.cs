...
namespace GameRealisticMap.ManMade.Roads
{
    internal class SidewalksBuilder : IDataBuilder<SidewalksData>
    {
        ...
        public SidewalksData Build(IBuildContext context, IProgressScope scope)
        {
            ...
            mask.AddRange(fences.WithProgress(scope, "Fences")
            ...
            var polygons = allRoads.WithProgress(scope, "Roads")
            ...
            using (var report = scope.CreateInteger("MergeRoads", polygons.Count))
            {
            ...
            var paths =
                polygons
                .WithProgress(scope, "SubstractAll")
            ...
            foreach (var path in paths.WithProgress(scope, "Orientation"))
            {
